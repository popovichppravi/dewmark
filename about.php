...
<!--Выбор языка-->
	...
	<div class="bx-breadcrumb">
			<div class="bx-breadcrumb-item" id="bx_breadcrumb_0" itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
				...
				<a href="/" title="База знаний" itemprop="url">
...
<img class="page_big_img" src="images/about.jpg">
<h2>О нас</h2>
<p>Компания "Дьюмарк" - российская компания работающая на рынке деформационных швов с 2007 года. Специалисты компании проектируют и создают профили для деформационных швов для самых различных объектов на территории как России, так и всего мира. Вся продукция компании "Дьюмарк" имеет сертификаты на территории Российской Федерации. Поставщиками исходного сырья являются ведущие компании России и европы. Продукция выпусается на современном европейском и японском оборудовании. Инженеры компании "Дьюмарк" оказывают консультационные услуги в выборе систем деформационных швов в самых обширных сферах строительства.</p>



<div class="prj_about">
<h2>Реализованные пректы</h2>
	<ul>
		<li><a href="#"><div class="cicle_img"><img src="images/ico_prj/ico_prj1.png"></div><span>Аэропорты</span></a></li>
		<li><a href="#"><div class="cicle_img"><img src="images/ico_prj/ico_prj2.png"></div><span>Торговые центры</span></a></li>
		<li><a href="#"><div class="cicle_img"><img src="images/ico_prj/ico_prj3.png"></div><span>Транспортные объекты</span></a></li>
		<li><a href="#"><div class="cicle_img"><img src="images/ico_prj/ico_prj4.png"></div><span>Больницы</span></a></li>
		<li><a href="#"><div class="cicle_img"><img src="images/ico_prj/ico_prj5.png"></div><span>Гостиницы</span></a></li>
		<li><a href="#"><div class="cicle_img"><img src="images/ico_prj/ico_prj6.png"></div><span>Промышленные объекты</span></a></li>
		<li><a href="#"><div class="cicle_img"><img src="images/ico_prj/ico_prj7.png"></div><span>Спортивные объекты</span></a></li>
	</ul>
	<div class="ta_right">
...
<div class="sert_about">
	<h2>Сертификаты</h2>
	<div class="table">
	<div class="cell">
<img src="images/sert_ico.png" alt="">
	</div>
<div class="right_div cell">
<p>Компания "Дьюмарк" - российская компания работающая на рынке деформационных швов с 2007 года. Специалисты компании проектируют и создают профили для деформационных швов для самых различных объектов на территории как России, так и всего мира. Вся продукция компании "Дьюмарк" имеет сертификаты на территории Российской Федерации.</p>
	<div class="ta_right">
...
<ul>
	<li><img src="images/usl1.png"><p>Подбор необходимых профилей исходя из расчетов</p></li>
	<li><img src="images/usl2.png"><p>Техническая поддержка всех этапов от согласования до установки</p></li>
	<li><img src="images/usl3.png"><p>Разработка новых типов профилей под конкретные проекты и условия</p></li>
</ul>
<div class="ta_right">
	<a href="#" class="btn">Все услуги<i class="fa fa-angle-right"></i></a>
</div>
