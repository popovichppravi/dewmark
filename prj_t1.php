...
<div class="page">
	<div class="container">
		<div class="compl_prj">
			<div class="top_div_cp">
			<div class="left_cp">
			<p>Тип объектов:</p>
				<div class="filter_cp">
					<div class="type_cp_now">Показать все<i class="fa fa-arrow-circle-o-down"></i></div>
					<div class="type_cp_list">
						<ul>
							<li><i class="fa fa-list"></i>Показать все</li>
							<li><i class="fa fa-shopping-cart"></i>Торговые центры</li>
							<li><i class="fa fa-building-o"></i>Гостиницы</li>
							<li><i class="fa fa-bed"></i>Больницы</li>
							<li><i class="fa fa-plane"></i>Аэропорты</li>
							<li><i class="fa fa-rocket"></i>Промышленные объекты</li>
							<li><i class="fa fa-car"></i>Транспортные объекты</li>
							<li><i class="fa fa-futbol-o"></i>Спортивные объекты</li>
						</ul>
					</div>
				</div>
			</div>
			<div class="right_cp">
				<div class="type_view_cp">
				<p>Режим отображения:</p>
					<div class="type_view_btn active_view" id="list_view"><i class="fa fa-th-list"></i></div>
					<div class="type_view_btn" id="list_view"><i class="fa fa-th-large"></i></div>
				</div>
			</div>
			</div>
			<ul class="prjts_list">
					<li class="prjs_item_list">
						<div class="prjs_item_img"><a href="#"><img src="images/prjcts/prj1.jpg"><i class="fa fa-hand-o-up"></i></a></div>
					<div class="prj_list_txt">
						<div class="date"><i class="fa fa-calendar"></i>01.01.16</div>
						<a href="#">Космодром «Восточный»</a>
						<p>В октябре 2014 года был заключен контракт на поставку профилей для деформационных швов Дьюмарк для различных объектов инфраструктуры космодрома "Восточный"</p>
					</div>	
				</li>
...
$( ".filter_cp" ).hover(
	function() 
		{
			$( ".type_cp_now i" ).toggleClass("fa-arrow-circle-o-down");
			$( ".type_cp_now i" ).toggleClass("fa-arrow-circle-o-up");
		});
			</script>
